...
function ImagePicker({onImagePicked}){
    ...
    async function takeImageHandler(){
        ...
        //const {status}  = await Camera.getCameraPermissionsAsync(Permissions.CAMERA_ROLL);
        console.log("image");
    ...
    return <View>
        ...
        <OulinedButton icon="camera" onPress={takeImageHandler}> Take Image</OulinedButton>
    </View>
}
